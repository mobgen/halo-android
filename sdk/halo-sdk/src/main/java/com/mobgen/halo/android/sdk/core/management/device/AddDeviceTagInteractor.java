...
public class AddDeviceTagInteractor implements HaloInteractorExecutor.Interactor<Device> {
     ...
     */
    public AddDeviceTagInteractor(@NonNull DeviceRepository deviceRepository, @Nullable List<HaloSegmentationTag> tags, boolean shouldSendDevice) {
    ...
    public HaloResultV2<Device> executeInteractor() throws Exception {
        mDeviceRepository.addTags(mTargetTags);
