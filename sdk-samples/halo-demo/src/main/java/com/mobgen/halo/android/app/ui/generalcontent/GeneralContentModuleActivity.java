...
import com.mobgen.halo.android.app.generated.HaloDataBase$$GeneratedMigration;
...
public class GeneralContentModuleActivity extends MobgenHaloActivity implements SwipeRefreshLayout.OnRefreshListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //api things
        HaloContentApi.with(MobgenHaloApplication.halo()).createAutoGeneratedTables(new HaloDataBase$$GeneratedMigration());
//        HaloContentQueryApi.with(MobgenHaloApplication.halo()).iansertArticle("The best article ever",new Date(),"Article","Summary",null,null)
//                .asContent(List<HaloContentInstance>)
...
//        public HaloContentSelectorFactory<List<Article>, Cursor> iansertArticle(String mTitle, Date mDate, String mArticle,
//                String mSummary, String mThumbnail, String mImage){
//            String query = "insert into HALO_GC_ARTICLE(GC_MTITLE,GC_MDATE,GC_MARTICLE,GC_MSUMMARY,GC_MTHUMBNAIL,GC_MIMAGE) VALUES (?,?,?,?,?,?);";
//            Object[] bindArgs = new Object[6];
//            bindArgs[0]=mTitle;
//            bindArgs[1]=mDate;
//            bindArgs[2]=mArticle;
//            bindArgs[3]=mSummary;
//            bindArgs[4]=mThumbnail;
//            bindArgs[5]=mImage;
//            return new HaloContentSelectorFactory<>(
//                    halo(),
//                    new GeneratedContentQueriesInteractor(new GeneratedContentQueriesRepository(new GeneratedContentQueriesLocalDataSource(halo().framework())),query,bindArgs),
//                    new Cursor2ContentInstanceGeneratedConverter(query, halo().framework().parser(), halo().framework().storage(HaloContentContract.HALO_CONTENT_STORAGE)),
