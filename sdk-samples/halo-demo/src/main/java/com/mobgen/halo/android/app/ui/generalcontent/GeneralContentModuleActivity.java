...
import com.mobgen.halo.android.app.generated.HaloTable$$Article;
import com.mobgen.halo.android.app.generated.HaloTable$$ContentVersion;
import com.mobgen.halo.android.app.generated.HaloTable$$QROffer;
...
public class GeneralContentModuleActivity extends MobgenHaloActivity implements SwipeRefreshLayout.OnRefreshListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SQLiteDatabase database =  MobgenHaloApplication.halo().framework().storage(HaloContentContract.HALO_CONTENT_STORAGE).db().getDatabase();
        Create.table(HaloTable$$ContentVersion.class).on(database, "Creates the HaloTable$ContentVersion table from codegen");
        Create.table(HaloTable$$Article.class).on(database, "Creates the HaloTable$$Article table from codegen");
        ...
        values2.put(HaloTable$$ContentVersion.TABLE_ID, 2);
        values2.put(HaloTable$$ContentVersion.TABLE_NAME, "HALO_GC_QROFFER");
        values2.put(HaloTable$$ContentVersion.TABLE_VERSION,15);
