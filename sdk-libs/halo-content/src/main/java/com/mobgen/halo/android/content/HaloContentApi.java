...
public class HaloContentApi extends HaloPluginApi {
     ...
     */
    private static GeneratedHaloDatabase createAutoGeneratedTables(@NonNull Halo halo, @NonNull GeneratedHaloDatabase generatedHaloDatabase) {
...
//    @Api(2.3)
//    @NonNull
//    public static HaloContentApi with(@NonNull Halo halo, @NonNull GeneratedHaloDatabase generatedHaloDatabase) {
//        return with(halo, null, generatedHaloDatabase);
//    }
