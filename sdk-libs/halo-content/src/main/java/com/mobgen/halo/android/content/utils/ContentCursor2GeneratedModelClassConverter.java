 ...
 */
public class ContentCursor2GeneratedModelClassConverter<T> implements ISelectorConverter<List<T>, Cursor> {
     ...
     */
    public ContentCursor2GeneratedModelClassConverter(@NonNull Class<T> clazz, @NonNull Parser.Factory factory) {
        mClazz = clazz;
        mParser = factory;
    }
