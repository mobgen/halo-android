...
/**
 * The halo activity for compatibility V4 that handles the presenter lifecycle.
 *
 * @param <P> The presenter type.
 */
@Keep
public abstract class HaloActivityV4<P extends HaloPresenter> extends AppCompatActivity implements PresenterLifeCycleHandler<P>, HaloViewTranslator {
