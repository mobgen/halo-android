...
/**
 * Base fragment for new versions of Android that supports the presenter pattern of MVP.
 *
 * @param <P> The presenter type.
 */
@Keep
public abstract class HaloFragment<P extends HaloPresenter> extends Fragment implements HaloViewTranslator, PresenterLifeCycleHandler<P> {
